...
public class ServletWebRequest extends ServletRequestAttributes implements NativeWebRequest {
	...
	public String[] getParameterValues(String paramName) {
		...
		System.out.println("HttpServletRequest:" + request.getClass());
		// TODO 获取所有key是paramName的 value
		String[] parameterValues = request.getParameterValues(paramName);
		System.out.println(paramName + "KKKKKKKKKKKKKK");
		System.out.println("AAAAAAAAA+" + (parameterValues == null));
		if(parameterValues != null){
			System.out.println("AAAAAAAm+" + parameterValues.length);
			if(parameterValues.length > 0){
				System.out.println("BBBBBB+" + parameterValues[0]);
			}
		}
		System.out.println("MMMMMMMMMMMMMMUU" + request.getRequestURL());
		System.out.println("MMMMMMMMMMMNN" + request.getAttribute("silentdoer"));
