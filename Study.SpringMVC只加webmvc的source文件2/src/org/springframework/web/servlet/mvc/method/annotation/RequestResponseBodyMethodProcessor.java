...
public class RequestResponseBodyMethodProcessor extends AbstractMessageConverterMethodProcessor {
	...
	// TODO 由代码可知 public @ResponseBody String test(){..}其实@ResponseBody还是注解在方法上，即不存在说注解在返回值上的说法
	@Override
	public boolean supportsReturnType(MethodParameter returnType) {
		// 4.0以后这个@ResponseBody可以注解在controller类上面，而其内部的被@RequestMapping注解的方法均可以被应用
	...
	public void handleReturnValue(Object returnValue, MethodParameter returnType,
		...
		// TODO 这个很重要，设置为true，则外层方法将返回一个null的ModelAndView
		mavContainer.setRequestHandled(true);
		ServletServerHttpRequest inputMessage = createInputMessage(webRequest);
		// TODO 一开始outputMessage里面的Headers是空的
