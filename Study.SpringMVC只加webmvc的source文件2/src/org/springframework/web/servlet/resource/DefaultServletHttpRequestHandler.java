...
public class DefaultServletHttpRequestHandler implements HttpRequestHandler, ServletContextAware {
	...
	public void handleRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// 查了下资料，似乎request.getRequestDispatcher(..)是基于当前servlet来内部转发请求，还是由此servlet来处理
		// 而通过servletContext.getNamedDispatcher("default")是可能交由其它servlet来处理的？？？
		// TODO defaultServletName 应该是 "default"，即是Tomcat 自带的那个
		RequestDispatcher rd = this.servletContext.getNamedDispatcher(this.defaultServletName);
		if (rd == null) {
			throw new IllegalStateException("A RequestDispatcher could not be located for the default servlet '" +
					this.defaultServletName + "'");
		}
		// TODO RequestDispatcher 就可以理解为一个servlet，然后这个forward就是service方法，但是不同的是request的URL会变成修改后的
