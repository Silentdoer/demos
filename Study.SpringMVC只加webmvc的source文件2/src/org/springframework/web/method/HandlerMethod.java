...
public class HandlerMethod {
	...
	public HandlerMethod(Object bean, Method method) {
		...
		System.out.println(String.format("HandlerMethod2:%s", this.getClass()));
		this.bean = bean;
	...
	public HandlerMethod(Object bean, String methodName, Class<?>... parameterTypes) throws NoSuchMethodException {
		...
		System.out.println(String.format("HandlerMethod3.1:%s", this.getClass()));
		this.bean = bean;
		this.beanFactory = null;
		this.beanType = ClassUtils.getUserClass(bean);
	...
	public HandlerMethod(String beanName, BeanFactory beanFactory, Method method) {
		...
		Assert.notNull(method, "Method is required");
		System.out.println(String.format("HandlerMethod:%s3.2", this.getClass()));
		this.bean = beanName;
	...
	protected HandlerMethod(HandlerMethod handlerMethod) {
		...
		System.out.println(String.format("HandlerMethod1:%s", this.getClass()));
	...
	private HandlerMethod(HandlerMethod handlerMethod, Object handler) {
		...
		System.out.println(String.format("HandlerMethod3.3:%s", this.getClass()));
		this.bean = handler;
		this.beanFactory = handlerMethod.beanFactory;
		this.beanType = handlerMethod.beanType;
		this.method = handlerMethod.method;
	...
	private MethodParameter[] initMethodParameters() {
		...
		for (int i = 0; i < count; i++) {
			// 注意HandlerMethodParameter是HandlerMethod的内部类，故它需要在HandlerMethod创建的前提
			// 下才能创建（类似this.new HandlerMethodParamter(i)，那么这个HandlerMethodParameter内部获得的外部类的this指针就是当前HandlerMethod）
