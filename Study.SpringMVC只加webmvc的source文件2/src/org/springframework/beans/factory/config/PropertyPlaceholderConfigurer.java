...
public class PropertyPlaceholderConfigurer extends PlaceholderConfigurerSupport {
	 ...
	 * This is the default.
	 */
	// TODO 之前有改过这个值，这个是说如果发现某个key在文件里找不到则会继续从System.getProperty里找。
	 ...
	 */
	// TODO 尽量不要用这个模式
	public static final int SYSTEM_PROPERTIES_MODE_OVERRIDE = 2;  // TODO 如果是这个模式则优先从System.getProperty里获取
	 ...
	 */
	// TODO 这个应该是为 beanFactory 处理所有BeanDefinition的入口？？（是的，修改BeanDefinition中的占位符）
	@Override
	...
	private class PlaceholderResolvingStringValueResolver implements StringValueResolver {
		...
		// TODO 重要方法，这个strVal就是" ${ mm}"
		@Override
		public String resolveStringValue(String strVal) throws BeansException {
			// resolved是处理后的值，strVal是${aa}的aa，而resolver提供对应的value（aa是key）
			String resolved = this.helper.replacePlaceholders(strVal, this.resolver);
			if (trimValues) {  // TODO 默认是false，所以要注意key=value的value部分不要有空白符。
