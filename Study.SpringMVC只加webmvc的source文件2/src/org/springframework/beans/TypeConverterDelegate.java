...
class TypeConverterDelegate {
	...
	public <T> T convertIfNecessary(Object newValue, Class<T> requiredType, MethodParameter methodParam)
		...
		// TODO bug ，这里应该要提供propertyName，否则后面无法找到那种注册了名字的PropertyEditor（用一个PropertyEditorHolder包装）
	...
	public <T> T convertIfNecessary(String propertyName, Object oldValue, Object newValue,
		...
		// Custom editor for this type? propertyName一直是null，难怪之前老是没用，因为key为null的找不到
		...
		// TODO newValue 可能是字符串，也可能是字符串数组
		...
		if (editor != null || (requiredType != null && !ClassUtils.isAssignableValue(requiredType, convertedValue))) {
			...
			// TODO 重要，PropertyEditor对象真正转换的地方，oldValue似乎是null，convertedValue还未转换
	...
	private Object doConvertValue(Object oldValue, Object newValue, Class<?> requiredType, PropertyEditor editor) {
		...
		if (editor != null && !(convertedValue instanceof String)) {  // 应该不进
		...
		if (requiredType != null && !requiredType.isArray() && convertedValue instanceof String[]) {
			...
			// TODO 当获取的参数是String[]（如m=uu&m=bb得到[0] uu [1] bb）由这里转换为uu,bb
			// TODO 由此可知，HandlerMethod的String参数可以承载String[]，只不过会转换为aa,bb的格式，而直接用String[]作为参数也行。
			// TODO 但当参数是数组时不会进入这里。
	...
	private Object doConvertTextValue(Object oldValue, String newTextValue, PropertyEditor editor) {
		...
		// TODO 当并发时都到了同一个editor的这里（editor是单例）那么会出现脏读。
