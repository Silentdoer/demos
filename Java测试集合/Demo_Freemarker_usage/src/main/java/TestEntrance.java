...
public class TestEntrance {
    ...
    public static void main(String[] args) throws IOException, TemplateException {
        ...
        System.out.println(FreemarkerUtils.viewRender(temp, model));
        final String temp2 = "<ul>\n<#list foos as foo><li>${foo}#</li>\n</#list></ul>\n${author}\n${uu!\"默认值\"}";
        model.clear();
        model.put("foos", Arrays.asList("后", "shi", "外网"));
        System.out.println(FreemarkerUtils.viewRender(temp2, model));
        System.out.println(StringUtils.join("<",StringUtils.repeat("-", 10), ">"));
        Template template = FreemarkerUtils.getTemplateFromStore("test.ftl");
        ...
        final String temp3 = "<#list studs as stud>" +
                ...
                "</#list>";
        System.out.println();
        System.out.println(FreemarkerUtils.viewRender(temp3, model));
        ...
        final String temp4 = "<#list studs as stud>" +
                ...
                "</#list>";
        System.out.println();
        System.out.println(FreemarkerUtils.viewRender(temp4, model));
        ...
        final String temp5 = "<#list 1..10 as t>" +
                ...
                "</#list>";
        System.out.println();
        System.out.println(FreemarkerUtils.viewRender(temp5, null));
    }
