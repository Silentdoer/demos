...
public class SimilarImageSearch {
    ...
    public static void main(String[] args) {
        ...
        String folder = ImageHelper.path + "\\SimilarImageSearch\\images\\";
        String hashCode = null;

        for (int i = 0; i < 7; i++) {
            String filename1 = folder + "example" + (i + 1) + ".jpg";
            System.out.println("real name:" + filename1);
            hashCode = produceFingerPrint(filename1);
        ...
        String sourceHashCode = produceFingerPrint(folder + "source.jpg");
